...
## To get started
1. Go to [http://archive.eso.org/eso/eso_archive_main.html](ESO's raw data archive) and search for the target you wish to observe (select ESPRESSO as the instrument and increase the maximum number of returned rows to a large number to make sure you retrieve all science exposures).
